...
public class ClaySoldierFollowKingGoal extends Goal {
    ...
    public ClaySoldierFollowKingGoal(Mob mob, double speedModifier, float stopDistance, float areaSize, @javax.annotation.Nullable Predicate<Mob> targetCondition) {
        this.mob = mob;
        this.followPredicate = targetCondition;
