...
public class FeatherModifier extends NonStackingCSModifier {

    public FeatherModifier(ModifierType modifierType, Item modifierItem, String modifierName, Color modifierColor, List<RegistryObject<CSModifier>> incompatibleModifiers) {
