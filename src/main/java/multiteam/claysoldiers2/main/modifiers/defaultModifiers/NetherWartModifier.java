...
public class NetherWartModifier extends NonStackingCSModifier {

    public NetherWartModifier(ModifierType modifierType, Item modifierItem, String modifierName, Color modifierColor, List<RegistryObject<CSModifier>> incompatibleModifiers) {
    ...
    public void additionalModifierRenderComponent(ClaySoldier thisSoldier, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource multiBufferSource, int packedLightIn, GeoModel model) {
        ...
        renderItemOnSoldierHead(ModItems.RENDERING_DISPLAY_NETHERWART.get(), 0.33f, 0.0d, thisSoldier, entityYaw, partialTicks, matrixStack, multiBufferSource, packedLightIn, model);
