...
public class FlintModifier extends NonStackingCSModifier {

    public FlintModifier(ModifierType modifierType, Item modifierItem, String modifierName, Color modifierColor, List<CSModifier> incompatibleModifiers) {
