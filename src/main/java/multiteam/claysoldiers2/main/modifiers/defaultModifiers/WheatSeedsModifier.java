...
public class WheatSeedsModifier extends CSModifier {
    ...
    public WheatSeedsModifier(ModifierType modifierType, Item modifierItem, String modifierName, Color modifierColor, boolean canBeStacked, int stackingLimit, List<CSModifier> incompatibleModifiers) {
