...
public class EnderEyeModifier extends NonStackingCSModifier {

    public EnderEyeModifier(ModifierType modifierType, Item modifierItem, String modifierName, Color modifierColor, List<RegistryObject<CSModifier>> incompatibleModifiers) {
