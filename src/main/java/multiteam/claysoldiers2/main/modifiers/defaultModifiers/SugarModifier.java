...
public class SugarModifier extends NonStackingCSModifier {

    public SugarModifier(ModifierType modifierType, Item modifierItem, String modifierName, Color modifierColor, List<CSModifier> incompatibleModifiers) {
