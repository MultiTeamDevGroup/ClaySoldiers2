...
public class GunpowderModifier extends CSModifier {
    ...
    public GunpowderModifier(ModifierType modifierType, Item modifierItem, String modifierName, Color modifierColor, boolean canBeStacked, int stackingLimit, List<CSModifier> incompatibleModifiers) {
