...
public class GlowstoneDustModifier extends NonStackingCSModifier {
    ...
    public GlowstoneDustModifier(ModifierType modifierType, Item modifierItem, String modifierName, Color modifierColor, List<CSModifier> incompatibleModifiers) {
