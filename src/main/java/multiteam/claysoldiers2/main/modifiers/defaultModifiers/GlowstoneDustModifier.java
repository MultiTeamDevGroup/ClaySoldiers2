...
public class GlowstoneDustModifier extends NonStackingCSModifier {

    public GlowstoneDustModifier(ModifierType modifierType, Item modifierItem, String modifierName, Color modifierColor, List<RegistryObject<CSModifier>> incompatibleModifiers) {
    ...
    public void onModifierTick(ClaySoldierEntity thisSoldier, Instance thisModifierInstance) {
        thisSoldier.addEffect(new MobEffectInstance(MobEffects.GLOWING, 1, 1, false, false));
    }
